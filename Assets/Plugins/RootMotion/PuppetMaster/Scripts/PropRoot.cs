...
namespace RootMotion.Dynamics {
	...
	public class PropRoot : MonoBehaviour {
		...
		void Start() {
			...
			if (currentProp != null) currentProp.PickUp(this);
		}
		...
		private void AttachProp(Prop prop) {
			...
			if (prop.additionalPin != null && prop.additionalPinTarget != null) {
				puppetMaster.AddMuscle(prop.additionalPin, prop.additionalPinTarget, prop.muscle.GetComponent<Rigidbody>(), prop.transform, prop.additionalPinProps);
			}
		}
