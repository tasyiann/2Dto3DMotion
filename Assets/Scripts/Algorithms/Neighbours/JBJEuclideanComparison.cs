...
public class JBJEuclideanComparison : AlgorithmSetNeighbours{
    ...
    private static int amountOfMainClustersToSearch = Base.numMainClustersToSearch;
    private static bool multiLevelClustering = Base.multiLevelClustering;

    private void multiLevelSearch()
    {
